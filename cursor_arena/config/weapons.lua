...
Config.Loadouts = {
    {
        ...
        weapons = {
            ...
            { id = 'spiderap', label = 'Spider AP',    weapon = 'WEAPON_SPIDERAP', ammo = 250, shop = true, price = 250 },
            { id = 'snakeap',  label = 'Snake AP',     weapon = 'WEAPON_SNAKEAP',  ammo = 250, shop = true, price = 250 },
            { id = 'bluewire', label = 'Blue Wire',    weapon = 'WEAPON_BLUEWIRE', ammo = 250, shop = true, price = 250 },
        },
    },
    {
        id = 'smg',
        ...
        weapons = {
            ...
            { id = 'chromewire',  label = 'Chrome Wire SMG',      weapon = 'WEAPON_CHROMEWIRESMG',      ammo = 250, shop = true, price = 400 },
            { id = 'chromiummp5', label = 'Chromium MP5',         weapon = 'WEAPON_CHROMIUMMP5',        ammo = 250, shop = true, price = 400 },
            { id = 'sharkmp',     label = 'Shark Machine Pistol', weapon = 'WEAPON_SHARKMACHINEPISTOL', ammo = 250, shop = true, price = 400 },
            { id = 'pinkwire',    label = 'Pink Wire SMG',        weapon = 'WEAPON_PINKWIRESMG',        ammo = 250, shop = true, price = 400 },
        },
    },
    {
        id = 'ar',
        ...
        weapons = {
            ...
            { id = 'portalpurple', label = 'Portal Purple', weapon = 'WEAPON_PORTALPURPLE', ammo = 250, shop = true, price = 500 },
            { id = 'easterar',     label = 'Easter AR',     weapon = 'WEAPON_EASTERAR',     ammo = 250, shop = true, price = 500 },
            { id = 'hazardar',     label = 'Hazard AR',     weapon = 'WEAPON_HAZARDAR',     ammo = 250, shop = true, price = 500 },
            { id = 'chromiumiso',  label = 'Chromium ISO',  weapon = 'WEAPON_CHROMIUMISO',  ammo = 250, shop = true, price = 500 },
        },
    },
}
